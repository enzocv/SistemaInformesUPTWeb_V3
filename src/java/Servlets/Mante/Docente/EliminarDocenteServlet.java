...
public class EliminarDocenteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EliminarDocenteServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EliminarDocenteServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        processRequest(request, response);
        ...
        negoDocente.EliminarDocente(codDocente);
        try {
            negoDocente.conexion.close();
        } catch (SQLException ex) {
            Logger.getLogger(EliminarDocenteServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
