                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txtCodigo" value="<%=codigoDoc%>" class="form-control" disabled/>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row" >
                                    <div class=" col-lg-6" style="">
                                        ...
                                        <input type="text" value="" name="txtCelular" class="form-control">
                                    </div>

                                    <div class=" col-lg-6" style="">
                                        <label style="padding-bottom: .5em;">Grado :</label>
                                        <input type="text" value="" name="txtGrado" class="form-control">
                                    </div>
                                </div>
                            </div>
