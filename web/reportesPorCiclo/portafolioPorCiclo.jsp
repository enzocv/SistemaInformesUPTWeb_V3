                ...
                if(tipo.equals("pdf")){
                    ...
                    <div class="container full-height" id="documento">
                        <div class="row form-reporte shadow full-height">
                            <embed class="reporte" src="RptInformePortafolioCiclos.jsp?doctype=pdf" width="100%" height="100%" type='application/pdf'>
                        </div>
                    </div>
                    <%
                }
                    ...
                    <div class="container full-height" id="documento">
                        <div class="row form-reporte shadow full-height">
                            <object width="100%" height="100%" class="container" type="text/html" data="RptInformePortafolioCiclos.jsp?doctype=html">
                            <p>backup content</p>
                            </object>
                        </div>
                    </div>
                    ...
                    %>
                    <div class="container">
                        <embed class="reporte" src="RptInformePortafolioCiclos.jsp?doctype=xls" width="100%" height="100%" type='text/html'>
                    </div>
                    <%
                }
            %>
